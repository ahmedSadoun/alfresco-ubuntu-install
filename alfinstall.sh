...
BRANCH=master
export BASE_DOWNLOAD=https://raw.githubusercontent.com/ahmedSadoun/alfresco-ubuntu-install/$BRANCH
...
export LIBREOFFICE=https://downloadarchive.documentfoundation.org/libreoffice/old/6.4.1.2/deb/x86_64/LibreOffice_6.4.1.2_Linux_x86-64_deb.tar.gz
